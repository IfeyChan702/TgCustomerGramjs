...
const {getReplyText,getAccountIdfromTelegramId,getLatestAccountIds,getLatestRegisterIds , getAccountByRegisterIdArray ,insertGroupChannel, getChatIdsByAccountInChannel, getChatIdsByAccountInMerchant, insertGroupMerchant, getChatIdsByChannelIdInChannel} = require("../models/app");
  ...
  for (const data of accountDetails) {
    ...
    client.addEventHandler(async (event) => {
      ...
      if (
        ...
        const sourceGroupIds = await getChatIdsByAccountInMerchant(AccountId);
      ...
      if (
        ...
        // const AccountId = await  getAccountIdfromTelegramId(meId);
        const channelGroupIds = await getChatIdsByAccountInChannel(AccountId);
